...
export class LocalSongStorage {
  ...
  static async deleteAllData(userEmail: string): Promise<boolean> {
    console.log(`🗑️ STARTING COMPLETE DATA DELETION FOR USER: ${userEmail}`);
    ...
    try {
      ...
      console.log('✅ Cleared BrowserFileSystem');
      ...
      console.log('✅ Cleared AudioFileStorage');
      ...
      console.log('✅ Cleared LocalSongStorageDB and IndexedDB');
      ...
      console.log(`✅ Cleared ${keysToDelete.length} localStorage items`);
      ...
      console.log('✅ Blob URLs revoked by storage cleanup');
