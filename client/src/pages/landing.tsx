        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          <Card className="bg-slate-800/50 border-slate-700">
            <CardHeader>
              ...
              <CardDescription className="text-gray-400">Timed MIDI events embedded in lyrics for lighting and effects control. Time stamps help your lyrics scroll in perfect time with the music Karaoke style.</CardDescription>
            </CardHeader>
          </Card>
